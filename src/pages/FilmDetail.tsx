        ...
        <div className="max-w-7xl mx-auto pb-20">
            ...
            <div className="px-6 py-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8 mt-8">
                    <div className="flex flex-col p-2 bg-card-bg rounded-4xl border border-card-border hover:border-brand-primary/40 transition-all duration-300 shadow-sm hover:shadow-md group">
                        <div className="relative w-full aspect-square overflow-hidden rounded-3xl">
                            <img src={detail?.teetee_img || film.poster || ''} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt={film.role_teetee || '-'} />
                            <div className="absolute inset-0 bg-linear-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        </div>
                        <div className="p-5 text-center">
                            <span className="block text-[12px] font-black uppercase tracking-[0.2em] text-brand-primary mb-2">Teetee Wanpichit</span>
                            <p className="text-lg font-bold text-content-text-main leading-tight">as <span className="text-brand-accent">{film.role_teetee || '-'}</span></p>
                        </div>
                    </div>
                    <div className="flex flex-col p-2 bg-card-bg rounded-4xl border border-card-border hover:border-brand-primary/40 transition-all duration-300 shadow-sm hover:shadow-md group">
                        <div className="relative w-full aspect-square overflow-hidden rounded-3xl">
                            <img src={detail?.por_img || film.poster || ''} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" alt={film.role_por || '-'} />
                            <div className="absolute inset-0 bg-linear-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        </div>
                        <div className="p-5 text-center">
                            <span className="block text-[12px] font-black uppercase tracking-[0.2em] text-brand-primary mb-2">Por Suppakarn</span>
                            <p className="text-lg font-bold text-content-text-main leading-tight">as <span className="text-brand-accent">{film.role_por || '-'}</span></p>
                        </div>
                    </div>
                </div>
            </div>
